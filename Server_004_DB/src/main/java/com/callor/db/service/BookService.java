...
public interface BookService {
	...
	public void insert(BookVO bookVO);	// CREATE, 데이터 추가  // VO로 보내면 insert가 더 단순화된다
	 ...
	 * 
	 * select() method는
	 * DB로부터 데이터를 읽어서 Controller에서 return 한다
	 * 
	 * 
	 */
	 ...
	 * 데이터를 UPDATE
	 */
	public void udate(BookVO bookVO);	// UPDATE, 데이터 변경(갱신, 수정)
