 ...
 * 		Web Application Service(MAS) : 서비스 개념
...
// 요규하기 때문에 코드를 직접작성하는 것은 
// 너무 어렵다
// 그래서 java에서 제공하는 JDK를 상속받아서 대부분의 기능을 처리하고
// 꼭 필요한 기능만 구현을 하게 된다.
...
// 1. 현재 컴퓨터에서 시작한 tomcat 이 응담을 수신한다
// 		http://localhost:8080 : tomcat 을 호출하는 Request
...
//		프로젝트내의 클래스 중에서 
//		@WebServlet("/home") Annotation로 설정된
// 		클래스를 찾는다
// 4. 클래스내의 doGet(....) method를 호출한다.
// 5. doGet() method의 코드를 재정의(Overriding) 하여
//		서비스를 구현하게 된다.
